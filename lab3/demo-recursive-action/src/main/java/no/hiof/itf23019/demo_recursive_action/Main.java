package no.hiof.itf23019.demo_recursive_action;

import java.util.List;
import java.util.concurrent.ForkJoinPool;
import java.util.concurrent.TimeUnit;

import no.hiof.itf23019.demo_recursive_action.task.Task;
import no.hiof.itf23019.demo_recursive_action.util.Product;
import no.hiof.itf23019.demo_recursive_action.util.ProductListGenerator;
