package no.hiof.itf23019.excutor_knn.parallel.group;

import java.util.List;
import java.util.concurrent.CountDownLatch;

import no.hiof.itf23019.excutor_knn.data.Distance;
import no.hiof.itf23019.excutor_knn.data.Sample;
import no.hiof.itf23019.excutor_knn.distances.EuclideanDistanceCalculator;
